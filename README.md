...
| <a name="input_calico_cni_type"></a> [calico\_cni\_type](#input\_calico\_cni\_type) | Set your cni type for Calico | `string` |
| <a name="input_calico_kubernetes_provider"></a> [calico\_kubernetes\_provider](#input\_calico\_kubernetes\_provider) | Set your cloud provider name for Calico | `string` |
